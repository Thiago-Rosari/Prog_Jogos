...
int APIENTRY WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
     ...
     int windowWidth = GetSystemMetrics(SM_CXSCREEN);   // variável para a largura da janela
     int windowHeight = GetSystemMetrics(SM_CYSCREEN);  // variável para a altura da janela
